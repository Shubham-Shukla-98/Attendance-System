...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar collapse in" aria-expanded="true" style="">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="update_existing.jsp"><em class="fa fa-bar-chart">&nbsp;</em>Update Existing</a></li>
...
">
            <tbody>
                <tr>
                    <td>Roll No  :</td>
                    <td><input type="text" name="roll_no" style="
    width: 174px;
    height: 24px;
"></td>
                </tr>
                <tr>
                    <td>Date : </td>
                    <td><input type="date" name="dat" style="
    height: 24px;
"></td>
                </tr>
                <tr>
    ...
    <select name="subject">
      ...
      </table><input type="submit" value="Change" name="change" style="
    margin-left: 20px;
    margin-top: 20px;
">
    </form>
                <a href="new.jsp">Insert new Class Record</a>
		    </div>
		</div>
